...
import 'package:gamebarin/pages/loading_page_create.dart';
...
class _GamePlayingPageState extends State<GamePlayingPage> {
  ...
  void connect() {
    widget.socket = IO.io('http://192.168.1.11:3000/', <String, dynamic>{
